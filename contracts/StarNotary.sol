...
contract StarNotary is ERC721, ERC721Full {
    ...
    constructor() public ERC721Full("Star Token", "STR") {}
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        //Caller must own one of the tokens to make the exchange
        require(
            ownerOf(_tokenId1) == msg.sender ||
                ownerOf(_tokenId2) == msg.sender,
            "Exchanger must own the tokens"
        );
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "Must Own the star");
